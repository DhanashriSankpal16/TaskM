...
namespace TaskM.Controllers
{
    public class EmployeeDetailsController : Controller
    {
        ...
        public EmployeeDetailsController(TaskMContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Project,Discription,StartDate,EndDate,MID,EmployeeName")] EmployeeDetails employeeDetails)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Project,Discription,StartDate,EndDate,MID,EmployeeName")] EmployeeDetails employeeDetails)
        {
